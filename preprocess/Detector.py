...
raw_image_folder = '/mnt/louisayu/nfs_share2/embryo/rawdata/' #put your raw data here
detection_results_folder =  '/mnt/louisayu/nfs_share2/embryo/Test_Image_Detection_Results_all_1018/' #store cropped images
detection_results_file = '/mnt/louisayu/nfs_share2/embryo/code/final/preprocess/Detection_Results_all.csv' #yolo output file
model_weights='/mnt/louisayu/nfs_share2/embryo/code/final/preprocess/roi_trained_weights_final.h5' #detector model weights
model_classes = '/mnt/louisayu/nfs_share2/embryo/code/final/preprocess/data_classes.txt' 
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        dest="score",
        default=0.10, #change default to 0.1
